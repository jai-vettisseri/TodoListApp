...
* API - https://localhost:7028/swagger/index.html

### To run the application
* Running Web\TodoListApp.Server will run client app also
* to run client App separately go to Web\TodoListApp.client [cd Web\TodoListApp.client] and run 
  * npm install
  * npm start
